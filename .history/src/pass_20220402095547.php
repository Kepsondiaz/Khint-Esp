...
<body class="d-flex flex-column h-100">
        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarCollapse">
            <ul class="navbar-nav me-auto mb-2 mb-md-0">
              <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="upload.php">Uploader Un Fichier</a>
              </li>
              <li class="nav-item">
    ...
    <main class="main">
    <button class="input-group-text bg-primary"  ><a class="text-decoration-none text-light " href="index.php">voir les Fichiers Uploader</a></button>
    </main>
