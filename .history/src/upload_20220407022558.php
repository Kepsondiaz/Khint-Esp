...
<body class="d-flex flex-column h-100">
    ...
    -->
            ...
            <select class="form-select" aria-label="Disabled select example" name="cours" id="" required>
                ...
                <option value="systeme_ex">Système D'exploitation</option>
            </select>
            <br>
            <div class="input-group mb-3 ">
                <input type="file" class="form-control" id="inputGroupFile02" name="                <input type="file" class="form-control" id="inputGroupFile02" name="fichier" required>
" required>
            </div>
            <div class>
